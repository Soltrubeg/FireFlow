...
public class DictionaryPutNode<K, V> extends DualGenericNode<K, V> {
    ...
    public DictionaryPutNode(WireType<K> type1, WireType<V> type2) {
        super("dictionary_put", type1 == null || type2 == null ? "Dictionary Put" : type1.getName() + " " + type2.getName() + " Dictionary Put", "Puts a value into a dictionary.", Material.DISPENSER, type1, type2);
